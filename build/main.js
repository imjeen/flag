...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PublicFooter = __webpack_require__(278);
	
	var _PublicFooter2 = _interopRequireDefault(_PublicFooter);
		...
		(0, _createClass3.default)(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_PublicFooter2.default, null)
				);
			}
		}]);
		return App;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(206)
	  , gOPN      = __webpack_require__(230).f
	  , toString  = {}.toString;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(173)(Function.call, __webpack_require__(231).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(258),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PublicHeader = __webpack_require__(263);
	
	var _PublicHeader2 = _interopRequireDefault(_PublicHeader);
	
	var _searchCreators = __webpack_require__(264);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
		return {
			doSearch: function doSearch(text) {
				dispatch((0, _searchCreators.setSearchNameValue)(text));
			}
		};
	};
	
	var Header = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_PublicHeader2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PublicHeader = function (_Component) {
		(0, _inherits3.default)(PublicHeader, _Component);
	
		function PublicHeader(props) {
			(0, _classCallCheck3.default)(this, PublicHeader);
	
			var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(PublicHeader).call(this, props));
	
			_this.state = {
				inputValue: _this.props.searchText || ""
			};
			return _this;
		}
	
		(0, _createClass3.default)(PublicHeader, [{
			key: "handleReset",
			...
			value: function componentWillMount() {
				...
				globalEventEmitter.subscribe('resetHeaderForm', function () {
					_this2.handleReset();
				});
			}
		}, {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"form",
							{ className: "header-search form-group", onSubmit: this.handSubmit.bind(this), ref: "REF_form" },
							_react2.default.createElement("input", { autoFocus: "true", className: "form-field", type: "text", name: "q", placeholder: "Search",
								value: this.state.inputValue,
								onChange: this.handleChange.bind(this) }),
							_react2.default.createElement(
								"button",
								{ type: "submit", className: "button-link" },
								_react2.default.createElement(
									"div",
									{ "data-svg-icon": true },
									_react2.default.createElement(
										"svg",
										{ viewBox: "0 0 24 24" },
										_react2.default.createElement("path", { d: "M15.5,14h-0.8l-0.3-0.3c1-1.1,1.6-2.6,1.6-4.2C16,5.9,13.1,3,9.5,3S3,5.9,3,9.5C3,13.1,5.9,16,9.5,16c1.6,0,3.1-0.6,4.2-1.6 l0.3,0.3v0.8l5,5l1.5-1.5L15.5,14z M9.5,14C7,14,5,12,5,9.5C5,7,7,5,9.5,5S14,7,14,9.5C14,12,12,14,9.5,14z" })
									)
								)
							)
						)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setSearchNameValue = setSearchNameValue;
	
	var _SearchTypes = __webpack_require__(265);
	
	function setSearchNameValue(nameValue) {
		return { type: _SearchTypes.SET_SEARCH_NAME_VALUE, nameValue: nameValue };
	}
...
/***/ function(module, exports) {
	...
	var SET_SEARCH_NAME_VALUE = exports.SET_SEARCH_NAME_VALUE = "SET_SEARCH_NAME_VALUE";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabCreators = __webpack_require__(267);
	
	var _PublicNav = __webpack_require__(269);
	
	var _PublicNav2 = _interopRequireDefault(_PublicNav);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
		return {
			onShowByType: function onShowByType(filter) {
				dispatch((0, _tabCreators.setTabType)(filter));
			}
		};
	};
	
	var Nav = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_PublicNav2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setTabType = setTabType;
	
	var _TabTypes = __webpack_require__(268);
	
	function setTabType(tab) {
		return { type: _TabTypes.SET_TAB_TYPE, tab: tab };
	}
...
/***/ function(module, exports) {
	...
	var SET_TAB_TYPE = exports.SET_TAB_TYPE = "SET_TAB_TYPE";
	
	var TAB_ALL = exports.TAB_ALL = "TAB_ALL";
	var TAB_EUROPE = exports.TAB_EUROPE = "TAB_EUROPE";
	var TAB_ASIA = exports.TAB_ASIA = "TAB_ASIA";
	var TAB_AFRICA = exports.TAB_AFRICA = "TAB_AFRICA";
	var TAB_AMERICA = exports.TAB_AMERICA = "TAB_AMERICA";
	var TAB_OCEANIA = exports.TAB_OCEANIA = "TAB_OCEANIA";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PublicNav = function (_Component) {
		(0, _inherits3.default)(PublicNav, _Component);
	
		function PublicNav() {
			(0, _classCallCheck3.default)(this, PublicNav);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(PublicNav).apply(this, arguments));
		}
	
		(0, _createClass3.default)(PublicNav, [{
			key: 'handleDelegateFromLink',
			value: function handleDelegateFromLink(e) {
				e.target.hasAttribute('data-type') && this.props.onShowByType(e.target.dataset.type);
			}
		}, {
			key: 'componentWillUpdate',
			value: function componentWillUpdate(nextPros, nextState) {
				nextPros.tabType && globalEventEmitter.dispatch('resetHeaderForm');
			}
		}, {
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'ul',
							{ className: 'nav-list', onClick: this.handleDelegateFromLink.bind(this) },
							_react2.default.createElement(
								'li',
								{ className: 'nav-item' },
								_react2.default.createElement(
									'a',
									{ 'data-type': 'TAB_ALL', className: this.props.tabType === "TAB_ALL" ? "nav-link on" : "nav-link" },
									'全部'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ 'data-type': 'TAB_EUROPE', className: this.props.tabType === "TAB_EUROPE" ? "nav-link on" : "nav-link" },
									'欧洲'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ 'data-type': 'TAB_ASIA', className: this.props.tabType === "TAB_ASIA" ? "nav-link on" : "nav-link" },
									'亚洲'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ 'data-type': 'TAB_AMERICA', className: this.props.tabType === "TAB_AMERICA" ? "nav-link on" : "nav-link" },
									'美洲'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ 'data-type': 'TAB_AFRICA', className: this.props.tabType === "TAB_AFRICA" ? "nav-link on" : "nav-link" },
									'非洲'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ 'data-type': 'TAB_OCEANIA', className: this.props.tabType === "TAB_OCEANIA" ? "nav-link on" : "nav-link" },
									'大洋洲'
								)
							)
						)
	...
	PublicNav.propTypes = {
		tabType: _react.PropTypes.string.isRequired,
		onShowByType: _react.PropTypes.func.isRequired
	};
	
	exports.default = PublicNav;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FlagList = __webpack_require__(271);
	
	var _FlagList2 = _interopRequireDefault(_FlagList);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var getTabCollect = function getTabCollect(flags, tabType) {
		switch (tabType) {
			case 'TAB_ALL':
				return flags;
			case tabType:
				return flags.filter(function (flag) {
					return flag.continent === tabType;
				});
		}
	};
	
	var getSearchResult = function getSearchResult(flags, name) {
		return flags.filter(function (flag) {
	...
	var getResult = function getResult(data) {
		return !!data.searchNameValue === false ? getTabCollect(data.flags, data.tabType) : getSearchResult(data.flags, data.searchNameValue);
	};
	...
	var Main = (0, _reactRedux.connect)(mapStatetoProps)(_FlagList2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FlagItem = __webpack_require__(277);
	
	var _FlagItem2 = _interopRequireDefault(_FlagItem);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var FlagList = function (_Component) {
		(0, _inherits3.default)(FlagList, _Component);
	
		function FlagList() {
			(0, _classCallCheck3.default)(this, FlagList);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FlagList).apply(this, arguments));
		}
	
		(0, _createClass3.default)(FlagList, [{
			key: "render",
			value: function render() {
				return _react2.default.createElement(
					"main",
					...
					_react2.default.createElement(
						"ul",
						{ className: "flag-list grid grid--center" },
						this.props.flags.map(function (item, key) {
							return _react2.default.createElement(_FlagItem2.default, (0, _extends3.default)({}, item, { key: key, className: 'cell--3-col cell--4-col-phone cell--4-col-tablet' }));
						})
					)
				);
			}
	...
	FlagList.propTypes = {
		flags: _react.PropTypes.array.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FlagItem = function (_Component) {
		(0, _inherits3.default)(FlagItem, _Component);
	
		function FlagItem() {
			(0, _classCallCheck3.default)(this, FlagItem);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FlagItem).apply(this, arguments));
		}
	
		(0, _createClass3.default)(FlagItem, [{
			key: "render",
			value: function render() {
	
				return _react2.default.createElement(
					"li",
					{ className: "flag-item " + this.props.className },
					_react2.default.createElement(
						"div",
						{ className: "flag-inner" },
						_react2.default.createElement(
							"figure",
							{ className: this.props.name + "-flag figure-flag" },
							this.props.name + " flag"
						),
						_react2.default.createElement(
							"h2",
							null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PublicFooter = function (_Component) {
		(0, _inherits3.default)(PublicFooter, _Component);
	
		function PublicFooter() {
			(0, _classCallCheck3.default)(this, PublicFooter);
			return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(PublicFooter).apply(this, arguments));
		}
	
		(0, _createClass3.default)(PublicFooter, [{
			key: "render",
			value: function render() {
				return _react2.default.createElement(
					"footer",
					{ className: "global-footer footer-to-bottom" },
					_react2.default.createElement(
						"div",
						{ className: "global-container" },
						_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flagData = __webpack_require__(281);
	
	var _flagData2 = _interopRequireDefault(_flagData);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var rootReducer = (0, _redux.combineReducers)({
		flagData: _flagData2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toConsumableArray2 = __webpack_require__(282);
	...
	var initialState = {
		tabType: _TabTypes.TAB_ALL,
		searchNameValue: "",
		flags: [{ id: 0, name: "Japan", chineseName: "日本", continent: "TAB_ASIA" }, { id: 1, name: "Yemen", chineseName: "也门", continent: "TAB_ASIA" },
		...
		{ id: 5, name: "Ukraine", chineseName: "乌克兰", continent: "TAB_EUROPE" }, { id: 6, name: "Laos", chineseName: "老挝", continent: "TAB_ASIA" }, { id: 7, name: "Sultan", chineseName: "苏丹", continent: "TAB_AFRICA" }, { id: 8, name: "Qatar", chineseName: "卡塔尔", continent: "TAB_ASIA" },
		// { id: 9,  name: "Georgia", chineseName: "格鲁吉亚（前苏联加盟共和国）",	 continent: "TAB_ASIA" },
		{ id: 10, name: "SierraLeone", chineseName: "塞拉利昂", continent: "TAB_AFRICA" }, { id: 11, name: "Russia", chineseName: "俄罗斯", continent: "TAB_EUROPE" }, { id: 12, name: "Italy", chineseName: "意大利", continent: "TAB_EUROPE" },
		// { id: 13, name: "Greenland",chineseName: "格陵兰",	 continent: "TAB_AMERICA" },
		{ id: 14, name: "Palau", chineseName: "帕劳", continent: "TAB_OCEANIA" }, { id: 15, name: "Thailand", chineseName: "泰国", continent: "TAB_ASIA" }, { id: 16, name: "Mauritius", chineseName: "毛里求斯", continent: "TAB_AFRICA" }, { id: 17, name: "Mali", chineseName: "马里", continent: "TAB_AFRICA" }, { id: 18, name: "NewCaledonia", chineseName: "新喀里多尼亚", continent: "TAB_OCEANIA" }, { id: 19, name: "Columbia", chineseName: "哥伦比亚", continent: "TAB_AMERICA" }, { id: 20, name: "Indonesia", chineseName: "印度尼西亚", continent: "TAB_ASIA" }]
	};
	...
	function flagData() {
		...
		switch (action.type) {
			case _TabTypes.SET_TAB_TYPE:
				return (0, _assign2.default)({}, state, {
					tabType: action.tab,
					searchNameValue: ''
				});
			case _SearchTypes.SET_SEARCH_NAME_VALUE:
				return (0, _assign2.default)({}, state, {
					tabType: '', //or TAB_ALL,
					searchNameValue: action.nameValue
				});
			case _actions.ADD_FLAG:
				return (0, _assign2.default)({}, state, {
					flags: [].concat((0, _toConsumableArray3.default)(state.flags), [{
						id: 1 + state.flags.reduce(function (preFlag, curFlag) {
							return Math.max(preFlag.id, curFlag.id);
						}, -1),
						name: action.name,
			...
			case _actions.EDIT_FLAG:
				return (0, _assign2.default)({}, state, {
					flags: state.flags.map(function (t) {
						t.id !== action.id ? t : (0, _assign2.default)({}, t, {
							name: action.name,
							chineseName: action.alias,
							continent: action.belongto
						});
			...
			case _actions.DELETE_FLAG:
				return state.flags.filter(function (flag) {
					return flag.id !== action.id;
				});
			default:
				return state;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(172).Array.from;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ITERATOR     = __webpack_require__(215)('iterator')
	  , SAFE_CLOSING = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// action creator
	function addFlag(name, alias, belongto) {
		return { type: types.ADD_FLAG, name: name, alias: alias, belongto: belongto };
	}
	
	function editFlag(id, name, alias, belongto) {
		return { type: types.EDIT_FLAG, id: id, name: name, alias: alias, belongto: belongto };
	}
	
	function deleteFlag(id) {
		return { type: types.DELETE_FLAG, id: id };
	}
...
/***/ function(module, exports) {
	...
	var ADD_FLAG = exports.ADD_FLAG = "ADD_FLAG";
	var EDIT_FLAG = exports.EDIT_FLAG = "EDIT_FLAG";
	var DELETE_FLAG = exports.DELETE_FLAG = "DELETE_FLAG";
