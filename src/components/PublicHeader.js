	...
	render(){
		return (<header className="global-header">
				<div className="global-container">
					...
					<form className="header-search form-group" onSubmit={this.handSubmit.bind(this)}>
						<input autoFocus="true" className="form-field" type="text" name="q" placeholder="Search"
							value={this.state.inputValue}
							onChange={this.handleChange.bind(this)} />
						<button type="button" className="button-link" onClick={this.handerSearch.bind(this)}>
							<div data-svg-icon>
